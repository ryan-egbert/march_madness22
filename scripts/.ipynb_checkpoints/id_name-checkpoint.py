...
with open('id_name.csv', 'r') as o:
    with open('id_name2.csv', 'w') as f:
        for line in o:
            team1 = line.split(',')[6]
            team2 = line.split(',')[7]
            team1id = []
            team2id = []
            for id_name in ids:
                if team1 == id_name['name']:
                    team1id.append(id_name['id'])
                if team2 == id_name['name']:
                    team2id.append(id_name['id'])
            f.write(line.replace('\n','') + ',' + ' '.join(team1id) + ',' + ' '.join(team2id) + '\n')
